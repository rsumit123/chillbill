...
from . import auth, users, groups, expenses, settlements, activity, uploads, recurring_rules
...
router.include_router(recurring_rules.router)  # prefix="/groups" already set on router
