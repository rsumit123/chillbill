        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-3xl font-semibold">ChillBill</span>
            </div>
            <p className="text-neutral-600 dark:text-neutral-300 text-lg leading-relaxed">Split expenses effortlessly. Keep trips, households, and events fair and transparent.</p>
            <div className="mt-8 rounded-xl border border-neutral-200/60 dark:border-neutral-800/60 bg-white/60 dark:bg-neutral-900/60 backdrop-blur p-5">
              <div className="text-sm font-medium text-neutral-700 dark:text-neutral-200 mb-1">Tip</div>
          ...
          <div className="w-full max-w-md mx-auto md:ml-auto">
            <div className="rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 bg-white/80 dark:bg-neutral-900/80 backdrop-blur p-6 sm:p-8 shadow-sm">
              <h1 className="text-xl font-semibold mb-1 text-neutral-900 dark:text-neutral-100">Welcome back</h1>
              <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-5">Sign in to continue</p>
              {error && (
              ...
              <div className="mt-5 text-sm text-center text-neutral-500 dark:text-neutral-400">
                No account? <Link to="/signup" className="text-blue-600 dark:text-blue-400 font-medium hover:underline">Create one</Link>
              </div>
            </div>
          </div>
        </div>
