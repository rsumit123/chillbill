        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-3">
            ...
            <NavLink
              ...
              className={({isActive}) => `p-2 rounded-lg transition-colors ${isActive ? 'text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-950' : 'text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800'}`}
              title="Settings"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
